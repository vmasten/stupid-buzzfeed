...
function makeQuizzes() {
  ...
  //Kris's quiz
  new QuizItem('How much outside space do you have?', ['A little', 'A lot', 'Way too much'], [1, 2, 3], '');
...
function renderStart() { // function that renders the dynamic bits of index.html
